...
// 4個でアクティブエリア(100vw - px-4*2)にちょうど収まるサイズ
// itemWidth = (100vw - 32px(左右padding) - 36px(gap*3)) / 4
const ITEM_WIDTH = 'calc((100vw - 68px) / 4)';
            ...
            >
                <div className="flex gap-3 px-4">
                    {items.map((label) => (
                        ...
                        >
                            <div
                                className="w-full aspect-square rounded-lg p-[3px] bg-white"
