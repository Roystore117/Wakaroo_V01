...
// カラフルで知育アプリっぽいサムネイル画像リスト（Unsplash）
const thumbnailImages: string[] = [
    ...
    'https://images.unsplash.com/photo-1569864358642-9d1684040f43?auto=format&fit=crop&w=400&q=80',
    'https://images.unsplash.com/photo-1513151233558-d860c5398176?auto=format&fit=crop&w=400&q=80',
    'https://images.unsplash.com/photo-1560421683-6856ea585c78?auto=format&fit=crop&w=400&q=80',
    'https://images.unsplash.com/photo-1582058091505-f87a2e55a40f?auto=format&fit=crop&w=400&q=80',
];

// サムネイル画像を取得
const getThumb = (i: number): string => thumbnailImages[i % thumbnailImages.length];

// ユーザーアバター画像（柴犬）
const avatarUrl = 'https://images.unsplash.com/photo-1587300003388-59208cc962cb?auto=format&fit=crop&w=100&q=80';
